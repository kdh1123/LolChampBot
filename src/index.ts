...
const sessions = new MemorySessionStore(env.SESSION_TTL_MINUTES * 60_000);
wireBot(
  client,
  new DiscordRecommendationController(
    new RecommendationService(new JsonChampionDataProvider(), new JsonChampionStatsProvider()),
    sessions,
  ),
);
