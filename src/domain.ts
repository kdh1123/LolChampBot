...
export interface StatsProviderMetadata {
  providerName: string;
  sourceUrl?: string;
  patch?: string;
  tierRange?: string;
...
export interface ChampionStatsProvider {
  getStats(position: Position): Promise<ChampionStats[]>;
  getMatchups(championId: string, position: Position): Promise<MatchupStats[]>;
  getMetadata(): Promise<StatsProviderMetadata>;
}
